      ...
      <section className="py-16 lg:py-24 container mx-auto px-6 max-w-[900px]">
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12 shadow-sm text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <a href="https://mail.google.com/mail/?view=cm&to=support@fortunekraftconsultancy.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-[#0A1628] hover:text-[#F0A500] transition-colors font-medium bg-[#F8F9FA] px-6 py-3 rounded-full border border-gray-100">
